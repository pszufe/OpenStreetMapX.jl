...
const LAYER_FEATURES = Dict(
	...
	8 => Style(0xFFFF00, 1.5, "."),  # Yellow
    9 => Style(0xF4CCCC, 1.5, "."),  # Vanilla Ice 
    10 => Style(0x351C75, 1.5, "."), # Persian Indigo 
    11 => Style(0x00FF00, 1.5, "."), # Lime
    12 => Style(0x00FFFF, 1.5, "."), # Aqua
    13 => Style(0x005353, 2.0, "."), # Sherpa Blue 
    14 => Style(0xBDAD7D, 1.5, "."), # Ecru
    15 => Style(0xFF00FF, 1.5, "."), # Fuchsia 
    16 => Style(0xB9D1D6, 1.5, "."), # Light Blue 
    17 => Style(0x7A00CC, 1.5, "."), # Violet
    18 => Style(0x004225, 1.5, "."), # British Racing Green 
    19 => Style(0x7E8386, 2.0, "."), # Silver
    20 => Style(0xB87333, 1.5, "."), # Copper
    21 => Style(0x800020, 1.5, "."), # Burgundy
    22 => Style(0x5B718D, 1.5, "."), # Ultramarine
    23 => Style(0x636F22, 1.5, "."), # Fiji Green 
    24 => Style(0xCAF4DF, 1.5, "."), # Mint
    25 => Style(0x231F66, 2.0, "."), # Midnight Blue
    26 => Style(0xE6DFE7, 1.5, ".")) # Selago
