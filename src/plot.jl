...
const Styles = Union{OpenStreetMapX.Style,Dict{Int,OpenStreetMapX.Style}}
gr();
...
function draw_ways!(p::Plots.Plot,nodes::Dict{Int,T}, ways::Vector{OpenStreetMapX.Way}, style::OpenStreetMapX.Styles,km::Bool) where T<:Union{OpenStreetMapX.LLA,OpenStreetMapX.ENU}
    for way in ways
...
function draw_ways!(p::Plots.Plot,nodes::Dict{Int,T}, ways::Vector{OpenStreetMapX.Way},class::Dict{Int,Int}, style::OpenStreetMapX.Styles,km::Bool) where T<:Union{OpenStreetMapX.LLA,OpenStreetMapX.ENU}
    for i = 1:length(ways)
...
function draw_buildings!(p::Plots.Plot,nodes::Dict{Int,T}, buildings::Vector{OpenStreetMapX.Way}, style::OpenStreetMapX.Styles,km::Bool) where T<:Union{OpenStreetMapX.LLA,OpenStreetMapX.ENU}
    if isa(style, OpenStreetMapX.Style)
...
function draw_roadways!(p::Plots.Plot,nodes::Dict{Int,T}, roadways::Vector{OpenStreetMapX.Way}, style::OpenStreetMapX.Styles,km::Bool) where T<:Union{OpenStreetMapX.LLA,OpenStreetMapX.ENU}
    if isa(style, OpenStreetMapX.Style)
...
function draw_walkways!(p::Plots.Plot,nodes::Dict{Int,T}, walkways::Vector{OpenStreetMapX.Way}, style::OpenStreetMapX.Styles,km::Bool) where T<:Union{OpenStreetMapX.LLA,OpenStreetMapX.ENU}
    if isa(style, OpenStreetMapX.Style)
...
function draw_cycleways!(p::Plots.Plot,nodes::Dict{Int,T}, cycleways::Vector{OpenStreetMapX.Way}, style::OpenStreetMapX.Styles,km::Bool) where T<:Union{OpenStreetMapX.LLA,OpenStreetMapX.ENU}
    if isa(style, OpenStreetMapX.Style)
...
function draw_features!(p::Plots.Plot,nodes::Dict{Int,T}, features::Dict{Int,Tuple{String,String}}, style::OpenStreetMapX.Styles,km::Bool) where T<:Union{OpenStreetMapX.LLA,OpenStreetMapX.ENU}
    if isa(style, OpenStreetMapX.Style)
...
function plotmap(nodes::Dict{Int,T},
                                    ...
                                    buildingStyle::Styles=OpenStreetMapX.Style("0x000000", 1, "-"),
                                    roadways::Union{Nothing,Vector{OpenStreetMapX.Way}} = nothing,
                                    roadwayStyle::Styles=OpenStreetMapX.Style("0x007CFF", 1.5, "-"),
                                    walkways::Union{Nothing,Vector{OpenStreetMapX.Way}} = nothing,
                                    walkwayStyle::Styles=OpenStreetMapX.Style("0x007CFF", 1.5, "-"),
                                    cycleways::Union{Nothing,Vector{OpenStreetMapX.Way}} = nothing,
                                    cyclewayStyle::Styles=OpenStreetMapX.Style("0x007CFF", 1.5, "-"),
                                    features::Union{Nothing,Dict{Int64,Tuple{String,String}}} = nothing,
                                    featureStyle::Styles=OpenStreetMapX.Style("0xCC0000", 2.5, "."),
                                    width::Int=600,
									height::Int=600,								
                                    fontsize::Integer=0,
...
function addroute!(p::Plots.Plot, nodes::Dict{Int,T}, route::Vector{Int}; route_color::String ="0x000053", km::Bool=false) where T<:Union{OpenStreetMapX.LLA,OpenStreetMapX.ENU}
    route_style = OpenStreetMapX.Style(route_color, 3, ";")
